...
const colPercent = (col, defaultValue = "") => {
    return col > 0 ? `${(col * 100) / 24}%;` : defaultValue;
};
const generateMediaQuery = (defaultBreakpoint, responsiveProp, responsiveBreakpoint) => `
  @media (min-width: ${responsiveBreakpoint ? responsiveBreakpoint : defaultBreakpoint}px) {
...
const StyledCol = styled.div `
  ...
  ${props => props.xl ? generateMediaQuery(1200, props.xl, props.xlBreak) : ""}
  ${props => props.xxl ? generateMediaQuery(1200, props.xxl, props.xxlBreak) : ""}
`;
